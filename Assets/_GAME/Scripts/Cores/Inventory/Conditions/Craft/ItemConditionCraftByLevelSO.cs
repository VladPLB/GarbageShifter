...
{
    [CreateAssetMenu(menuName = "Inventory/Condition/Craft/ByLevelSO", fileName = "ItemConditionCraftByLevel_")]
    public class ItemConditionCraftByLevelSO: ItemConditionCraftSO
    {
        [SerializeField]
        private int _min = 0;
        [SerializeField]
